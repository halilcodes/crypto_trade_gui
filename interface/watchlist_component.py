...
class Watchlist(tk.Frame):
    def __init__(self, binance_contracts: typing.Dict[str, Contract], *args, **kwargs):
        ...
        self._binance_label = tk.Label(self._commands_frame, text="Binance", bg=BG_COLOR,
        ...
        self._bitmex_label = tk.Label(self._commands_frame, text="Bitmex", bg=BG_COLOR,
                                      fg= FG_COLOR, font=BOLD_FONT)
    ...
    def _add_bitmex_symbol(self, event):
        ...
        event.widget.delete(0, tk.END)
        print("Bitmex Client is not active")
    ...
    def _add_symbol(self, symbol: str, exchange: str):
        ...
        self.body_widgets['symbol'][b_index] = tk.Label(self._table_frame, text=symbol.upper(), bg=BG_COLOR, fg=FG_COLOR_2,
                                                        font=GLOBAL_FONT)
